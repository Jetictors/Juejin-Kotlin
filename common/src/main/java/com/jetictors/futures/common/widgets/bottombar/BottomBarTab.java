package com.jetictors.futures.common.widgets.bottombar;
...
//        typedArray.recycle();
      ...
      if (selectIcon==0){
          ...
          mIcon.setColorFilter(ContextCompat.getColor(context, R.color.clr_72777b));
      }else{
        mIcon.setImageResource(defIcon);
        mIcon.setLayoutParams(params);
        mIcon.setImageResource(defIcon);
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.clr_72777b));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            if (selectIcon==0){
                mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.clr_3780f7));
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.clr_black));
            }else{
            ...
            if (selectIcon==0){
                mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.clr_72777b));
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.clr_72777b));
            }else{
                mIcon.setImageResource(defIcon);
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.clr_72777b));
            }
